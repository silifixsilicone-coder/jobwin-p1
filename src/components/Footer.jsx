            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm font-medium">
                        <li className="flex items-center gap-3"><MapPin size={18} className="text-primary" /> Mumbai, Maharashtra, India</li>
                        <li className="flex items-center gap-3"><Phone size={18} className="text-primary" /> +91 98765 43210</li>
                        <li className="flex items-center gap-3"><Mail size={18} className="text-primary" /> contact@winsizer.com</li>
                    </ul>
                </div>
