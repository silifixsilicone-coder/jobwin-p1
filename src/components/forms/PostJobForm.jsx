...
import { FilePlus, MapPin, IndianRupee, AlignLeft, Send, CheckCircle2, User, Loader2, Camera } from 'lucide-react';
    ...
    if (success) {
        return (
            ...
            >
                ...
                <button onClick={() => setSuccess(false)} className="text-primary font-black uppercase text-xs tracking-widest hover:underline">Post Another Job</button>
            </motion.div>
        );
    }
                ...
                <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
                    ...
                    <div className="flex-1 w-full space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">WhatsApp Hotline</label>
                                <input
                                    type="tel"
                                    required
            ...
            <div className="space-y-8 text-[#1A1A1A]">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        required
                        className="w-full px-5 py-4 bg-light-grey border border-slate-200 rounded-md focus:ring-2 focus:ring-primary outline-none transition-all font-bold"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-black uppercase tracking-tight flex items-center gap-2">
                            <IndianRupee size={18} className="text-primary" /> Budget Range (â‚¹)
                        </label>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        required
                        rows="6"
                        className="w-full px-5 py-4 bg-light-grey border border-slate-200 rounded-md focus:ring-2 focus:ring-primary outline-none transition-all resize-none font-medium text-slate-700"
